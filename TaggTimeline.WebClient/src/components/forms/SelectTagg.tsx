  ...
  return shouldCreateTagg ? (
    ...
    <Card sx={{ display: "flex", flexDirection: "column" }}>
      ...
      <List disablePadding sx={{ overflow: "auto", flex: "1 1 auto" }}>
        {taggListItems.length === 0 && taggs.status === DataStatus.LOADED ? (
